...
const services = [
  {
    ...
    features: ["React & Next.js", "TypeScript", "Animations & Micro-interactions", "Accessibility (a11y)"],
    color: "cyan",
  },
  {
    icon: Database,
  ...
  },
  {
    ...
    features: ["System Architecture", "Cloud Deployment", "CI/CD Pipelines", "DevOps & Docker"],
    color: "blue",
  },
  {
    icon: Webhook,
    ...
    features: ["REST API Design", "JWT & OAuth", "OpenAPI / Swagger", "Rate Limiting & Caching"],
    color: "orange",
  },
  {
    ...
    features: ["Mobile-First Design", "Cross-browser Compat.", "Performance Auditing", "Core Web Vitals"],
    color: "pink",
  },
  {
    icon: Code2,
...
const colorConfig: Record<string, { icon: string; border: string; num: string; dot: string }> = {
  cyan: { icon: "bg-accent-cyan/10 text-accent-cyan", border: "hover:border-accent-cyan/40", num: "text-accent-cyan/20", dot: "bg-accent-cyan" },
  purple: { icon: "bg-accent-purple/10 text-accent-purple", border: "hover:border-accent-purple/40", num: "text-accent-purple/20", dot: "bg-accent-purple" },
